...
public class ImagesConst {
	...
	public static BufferedImage[] HOUSE, ROCK, TREE, FOREST_TREE, DUNGEON_WALL;
	...
	public static BufferedImage[] BUSH, CHEST, TORCH, CAVE_WALL;
	...
	public ImagesConst() throws IOException {
		...
		FOREST_TREE = loadSprite("forest_tree", 1, 1);
